				...
				<div class="wrap container-home">
					<div class="container">
						<div id="first" class="col-md-12">
							<div class="logo-home">
								%{--<g:link controller="home" action="index"><asset:image class="imagem-logo" src="giftcard-512.png" alt="COOP"/></g:link>--}%
							</div>
						...
						<div id="second">
							...
							<div id='login'>
								...
								<div class="row vertical-offset-100">
									<div class="col-md-1">
										<div class="panel panel-default  col-md-offset-12">
...
<div class="visible-xs">
	<div class="col-xs-12 col-md-12">
		<div class="row">
			<div class="container"     style="padding-right: inherit !important;">

				<div id='login-mobile' style="
				margin: 15px;
				">
