...
<html>
	...
	<body>
		<a href="#edit-fieldReport" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-fieldReport" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${fieldReportInstance?.version}" />
				<fieldset class="form">
