...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <g:set var="processamentos" value="${grailsApplication.config.project.processamentos}"></g:set>
        <g:if test="${processamentos}">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                <g:each in="${processamentos}" var="p">
                    <tr>
                        <td>${p}</td>
                        <td class="text-center">
                            <g:link class="btn btn-sm btn-primary" title="Executar" controller="processamento" action="execute" id="${p}">
        ...
        <g:else>
            <div class="well text-center">Sem Registro</div>
        </g:else>
    </div>
</div>
</body>
