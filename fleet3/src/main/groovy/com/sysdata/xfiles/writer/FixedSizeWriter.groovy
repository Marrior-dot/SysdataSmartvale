    ...
    def writeField(Object rawFieldValue, Map specField) {
        ...
        switch (specField.datatype) {
            ...
            case [FieldDataType.INTEGER, FieldDataType.LONG, FieldDataType.BYTE]:
                ...
                else throw new RuntimeException("Valor ($rawFieldValue) do campo ($specField.name) não é do tipo especificado!!!")
                break
            ...
            case FieldDataType.DATE_TIME:
                if (! specField.format) throw new RuntimeException("Campo data/hora (${specField.name}) sem formatação definida!")
