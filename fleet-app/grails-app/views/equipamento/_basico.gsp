...
<div class="panel panel-default">
	...
	<div class="panel-body">
			...
			<div class="row">
				<div class="form-group col-md-3">
					...
					<g:textField class="form-control" name="codigo" value="${equipamentoInstance?.codigo}" maxlength="10" required=""
	...
	<div class="panel-footer">
		<g:if test="${action=='novo'}">
			<g:actionSubmit class="btn btn-success" action="save" value="${message(code: 'default.button.update.label', default: 'Update')}" />
		</g:if>
		...
		<g:if test="${action=='visualizando'}">
			<g:actionSubmit class="btn btn-default" action="edit" value="${message(code: 'default.button.edit.label', default: 'Edit')}" /></span>
