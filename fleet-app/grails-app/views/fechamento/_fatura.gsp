<g:if test="${fatura}">
    <div class="panel panel-default">
        <div class="panel-heading">Fatura de Cliente</div>
        ...
        <div class="panel-footer">
            <a type="button" class="btn btn-sm btn-default" title="Voltar" onclick="abrirCortes(${fatura.corte.fechamento.id})">
                <i class="glyphicon glyphicon-arrow-left"></i> Voltar
            </a>
        </div>
    </div>

    <g:render template="faturasPortadores" model="[faturasPortadoresList: faturasPortadoresList]"></g:render>
