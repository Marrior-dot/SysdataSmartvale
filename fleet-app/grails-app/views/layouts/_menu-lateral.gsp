                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <sec:ifAnyGranted roles="ROLE_ADMIN, ROLE_PROC, ROLE_RH">
                            ...
                            <li class="controller"><g:link  class="submenu-logado"  controller="ConsumoMesRelatorio">Consumo por Mensal</g:link></li>
                            <li class="controller"><g:link  class="submenu-logado"  controller="EvolutivoConsumoRelatporio">Envolutivo de Consumo</g:link></li>
