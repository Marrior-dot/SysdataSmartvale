                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="estado"><g:message code="cidade.estado.label" default="Estado" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: cidadeInstance, field: 'estado', 'errors')}">
                                    <g:select name="estado.id" from="${com.sysdata.gestaofrota.Estado.list()}" optionKey="id" optionValue="uf" value="${cidadeInstance?.estado?.id}"  />
                                </td>
                            </tr>
