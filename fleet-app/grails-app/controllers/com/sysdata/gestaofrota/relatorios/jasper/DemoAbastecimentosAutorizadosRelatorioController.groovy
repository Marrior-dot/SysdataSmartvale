...
class DemoAbastecimentosAutorizadosRelatorioController extends JasperBaseRelatorioController {
    ...
    def list() {
        if (params.dataInicial && params.dataFinal) {
            ...
            try {
                exportToPdf(grailsApplication, "rel_DemoAbastecimentosAutorizados", params, outputStream)
            }
            finally {
                outputStream.flush()
                outputStream.close()
