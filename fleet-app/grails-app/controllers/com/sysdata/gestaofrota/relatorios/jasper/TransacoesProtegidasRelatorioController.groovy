...
class TransacoesProtegidasRelatorioController extends JasperBaseRelatorioController {
    ...
    def list() {
        if (params.dataInicial && params.dataFinal) {
            ...
            try {
                exportToPdf(grailsApplication, "rel_TransProtegidas", params, outputStream)
            } catch (e) {
