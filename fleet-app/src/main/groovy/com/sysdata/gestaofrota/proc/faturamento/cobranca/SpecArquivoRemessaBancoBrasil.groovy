...
class SpecArquivoRemessaBancoBrasil {
    ...
    static final SpecRecord regHeader = new SpecRecord(id: "0", name: "Registro Header",
        ...
        fields: [
            ...
            [name: "identificacaoTipoServico", size: 1, value: "COBRANCA"],
            [name: "brancos1", size: 7, value: ""],
            [name: "agenciaBeneficiario", size: 4],
            ...
            [name: "dataGravacao", datatype: FieldDataType.DATE_TIME, format: "ddMMyy"],
            ...
            [name: "sequencialRegistro", size: 6, value: "0000001"]
        ]
    )
    ...
    static final SpecRecord regDetalhe = new SpecRecord(id: "7", name: "Registro Detalhe",
        ...
        fields: [
            ...
            [name: "tipoInscricao", size: 2],
            [name: "cpfCnpj", size: 14],
            ...
            [name: "nossoNumero", size: 17, datatype: FieldDataType.INTEGER],
            [name: "numeroPrestacao", value: "00"],
            [name: "grupoValor", value: "00"],
            [name: "tipoMoeda", value: "00"],
            ...
            [name: "contaCaucao", value: "0"],
            [name: "numeroBordero", size: 6, value: "0"],
            [name: "tipoCobranca", size: 5, value: ""],
            [name: "carteiraCobranca", size: 2, datatype: FieldDataType.INTEGER],
            [name: "comando", size: 2, datatype: FieldDataType.INTEGER],
            [name: "seuNumeroNumeroTitulo", size: 10],
            [name: "dataVencimento", datatype: FieldDataType.DATE_TIME, format: "ddMMyy"],
            [name: "valorTitulo", size: 13, datatype: FieldDataType.LONG],
            [name: "numeroBanco", value: "001"],
            [name: "prefixoAgenciaCobradora", value: "0000"],
            ...
            [name: "dataEmissao", datatype: FieldDataType.DATE_TIME, format: "ddMMyy"],
            [name: "instrucao1", size: 2, datatype: FieldDataType.INTEGER],
            [name: "instrucao2", size: 2, datatype: FieldDataType.INTEGER],
            [name: "jurosDeMora", size: 13, datatype: FieldDataType.LONG],
            [name: "dataLimiteDesconto", datatype: FieldDataType.DATE_TIME, format: "ddMMyy"],
            ...
            [name: "observacoesMensagensAvalista", size: 40],
            [name: "diasProtestoNegativacao", size: 2],
            [name: "indicadorRecebimentoParcial", size: 1],
